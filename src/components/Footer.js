      ...
      <div className="">
        <footer className="footer">
          <div className="content is-small has-text-centered">
            <div>
              <strong>{text}</strong>
              <p className="is-marginless">tel: <a href={`tel:${telephone}`}>{telephone}</a> - {telephoneName}</p>
              <p className="is-marginless">tel: <a href={`tel:${telephone2}`}>{telephone2}</a> - {telephone2Name}</p>
